      ...
      <div className="max-w-6xl mx-auto">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-all duration-200 ${
                  activeCategory === category.id
                    ...
                    : 'bg-white/80 text-gray-600 hover:bg-blue-50 hover:text-blue-700'
                }`}
              >
                <Icon size={18} />
                {category.label}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {getFilteredProjects().map((project, index) => (
            <div
              key={project.id}
              className="bg-white/80 backdrop-blur-sm border border-slate-200 rounded-xl p-6 cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl hover:bg-blue-50/30 animate-fade-in"
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {project.tech.length > 3 && (
                  <span className="px-2 py-1 bg-slate-50 text-slate-600 text-xs rounded-md font-medium">
